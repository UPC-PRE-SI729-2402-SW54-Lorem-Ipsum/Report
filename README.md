...
![Commits-report-tb1](https://i.imgur.com/GoczsTB.png)
...
**_Segmento Objetivo 1: Lucía Martinez - Abogada_**
![Impact Mapping](assets/images/Impact-map-abogado.png)


**_Segmento Objetivo 2: Jean Patrick Sanchez Rios - Cliente_**
![Impact Mapping](assets/images/Impact-Mapping-Segmento-2.png)
...
### 5.1.4. Software Deployment Configuration
<p>Para desplegar la landing page, se usará Github Pages, herramienta que nos permitirá desplegar la página a partir de un repositorio.</p> 
...
- Búsqueda y filtrado de abogados.
